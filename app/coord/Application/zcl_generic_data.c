...
const uint8_t Generic_AppVersion = 0x06;
const uint8_t Generic_ManufacturerName[] = { 16, 'C','h','e','n','g','D','u','X','i','n','Y','i','G','o','u','!' };
uint8_t Generic_PhysicalEnvironment = PHY_UNSPECIFIED_ENV;

// Time Cluster
uint32_t Generic_UtcTime = 0;
...
CONST uint8 zclCmdsArraySize = sizeof(Generic_Cmds)/sizeof(zclCommandRec_t);
